    ...
    >
      <div className="flex flex-col items-center justify-center md:flex-row-reverse md:w-10/12 md:justify-between">
        ...
        <div className="font-dosis w-full md:w-3/5 text-center md:text-left ">
          ...
          <a href="https://drive.google.com/file/d/1depwSxYTn3yjpfpLLSB9D1AFcg3BmuOO/view?usp=sharing">
            <button
              className={` animate-bounce bg-orange-500 px-10 py-3 m-3 text-lg uppercase text-white rounded-lg mt-10 hover:bg-red-300 transform  ${
                animated ? 'translate-y-0' : styleTranslate
              } ${transition(3500)}`}
            >
              {content.header.btnCvText}
            </button>
           </a>
        </div>
      </div>
